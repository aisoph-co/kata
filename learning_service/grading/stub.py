"""Deterministic `short_answer` grader behind `LEARNING_LLM=stub`: a
demo/test mode that never calls OpenRouter, so CI never spends money or
flakes on a live model (spec §Testing, "Grading").
