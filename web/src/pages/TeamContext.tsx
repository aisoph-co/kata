...
// Not gated on import.meta.env.DEV: the Playwright suite also runs against
// the built-and-served (PLAN_10 Docker/Caddy) production bundle, where DEV
// is always false. The value carries nothing sensitive (node/edge counts,
