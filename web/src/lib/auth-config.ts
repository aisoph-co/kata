 ...
 *
 * `AUTH_ENABLED` is what lets local dev and the existing e2e suite keep
 * running against today's persona-switcher demo mode, untouched, whenever
 * these two are unset — which is the default everywhere but a deployment
